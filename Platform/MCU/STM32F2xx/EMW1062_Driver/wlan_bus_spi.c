...
OSStatus host_platform_bus_init( void )
{
    ...
    platform_gpio_output_high( &wifi_control_pins[EMW1062_PIN_BOOTSTRAP_0] );
...
#if defined ( MICO_WIFI_USE_GPIO_FOR_BOOTSTRAP )
    /* Clear GPIO_B[1:0] */
    platform_gpio_init( &wifi_control_pins[EMW1062_PIN_BOOTSTRAP_0], INPUT_HIGH_IMPEDANCE );
    platform_gpio_init( &wifi_control_pins[EMW1062_PIN_BOOTSTRAP_1], INPUT_HIGH_IMPEDANCE );
#endif
