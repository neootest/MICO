...
/**
 * @brief  Config power of all module before putting the system into deep sleep mode.
 * @param  None.
 * @return None.
 * @pre	   The SysSetWakeUpSrcInDeepSleep() function must be executed previously.
 * @Note   This function should be followed by function  SysGotoDeepSleep().
 */
void SysGotoDeepSleepCfg(void);
