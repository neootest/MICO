/*
 * @brief LPC540XX State Configurable Timer (SCT) Chip driver
 *
 * @note
...
#ifndef __SCT_540XX_H_
#define __SCT_540XX_H_

#ifdef __cplusplus
extern "C" {
#endif

    /** @defgroup SCT_540XX CHIP: LPC540XX State Configurable Timer driver
