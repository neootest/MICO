/*
 * @brief LPC540XX Multi-Rate Timer (MRT) registers and driver functions
 *
 * @note
...
#ifndef __MRT_540XX_H_
#define __MRT_540XX_H_

#ifdef __cplusplus
extern "C" {
#endif

/** @defgroup MRT_540XX CHIP: LPC540XX Multi-Rate Timer driver
