...
#ifndef __GPIOGROUP_540XX_H_
#define __GPIOGROUP_540XX_H_

#ifdef __cplusplus
extern "C" {
#endif

/** @defgroup GPIOGP_540XX CHIP: LPC540xx GPIO group driver
 ...
 * @param	pGPIO	: The base of GPIO group peripheral on the chip
 * @return	Nothing
 */
...
STATIC INLINE void Chip_GPIOGP_ClearIntStatus(LPC_GPIOGROUPINT_T *pGPIOGPINT, uint8_t group)
{
	...
	temp = pGPIOGPINT[group].CTRL & GPIOGR_CTRL_MASK;
...
{
	pGPIOGPINT[group].CTRL = (pGPIOGPINT[group].CTRL & GPIOGR_CTRL_MASK) & ~GPIOGR_COMB;
}
...
{
	pGPIOGPINT[group].CTRL = (pGPIOGPINT[group].CTRL & GPIOGR_CTRL_MASK) & ~GPIOGR_TRIG;
}
