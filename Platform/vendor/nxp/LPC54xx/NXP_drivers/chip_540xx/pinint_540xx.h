/*
 * @brief LPC540XX Pin Interrupt and Pattern Match Registers and driver
 *
 * @note
...
#ifndef __PININT_540XX_H_
#define __PININT_540XX_H_

#ifdef __cplusplus
extern "C" {
#endif

/** @defgroup PININT_540XX CHIP: LPC540XX Pin Interrupt and Pattern Match driver
