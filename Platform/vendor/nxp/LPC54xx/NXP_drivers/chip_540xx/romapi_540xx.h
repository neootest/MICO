/*
 * @brief LPC540XX ROM API declarations and functions
 *
 * @note
...
#ifndef __ROMAPI_540XX_H_
#define __ROMAPI_540XX_H_

#include "iap.h"
#include "error.h"
#include "rom_adc_540xx.h"
//#include "rom_can_540xx.h" // FIXME
#include "rom_dma_540xx.h"
#include "rom_i2c_540xx.h"
#include "rom_pwr_540xx.h"
#include "rom_spi_540xx.h"
#include "rom_uart_540xx.h"

#ifdef __cplusplus
extern "C" {
#endif

/** @defgroup ROMAPI_540XX CHIP: LPC540XX ROM API declarations and functions
...
/* Pointer to @ref SPID_API_T functions in ROM for SPI */
...
/**
 * @brief LPC540xx IAP_ENTRY API function type
 */
