/*
 * @brief LPC540XX WWDT chip driver
 *
 * @note
...
#ifndef __WWDT_540XX_H_
#define __WWDT_540XX_H_

#ifdef __cplusplus
extern "C" {
#endif

/** @defgroup LPC_WWDT CHIP: LPC540XX Windowed Watchdog driver
