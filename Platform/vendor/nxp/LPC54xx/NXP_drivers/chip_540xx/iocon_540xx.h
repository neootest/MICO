/*
 * @brief LPC540XX IOCON register block and driver
 *
 * @note
...
// FIXME this driver needs to support the standard IOCON functions that all other drivers support

#ifndef __IOCON_540XX_H_
#define __IOCON_540XX_H_

#ifdef __cplusplus
extern "C" {
#endif

/** @defgroup IOCON_540XX CHIP: LPC540XX IOCON register block and driver
