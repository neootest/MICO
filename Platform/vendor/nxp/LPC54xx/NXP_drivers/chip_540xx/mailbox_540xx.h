/*
 * @brief LPC540XX Mailbox M4/M0+ driver
 *
 * @note
...
#ifndef __MAILBOX_540XX_H_
#define __MAILBOX_540XX_H_

#ifdef __cplusplus
extern "C" {
#endif

/** @defgroup MAILBOX_540XX CHIP: LPC540XX Mailbox M4/M0+ driver
...
{
	Chip_Clock_EnablePeriphClock(SYSCTL_CLOCK_MBOX);
}
...
{
	Chip_Clock_DisablePeriphClock(SYSCTL_CLOCK_MBOX);
}
 ...
 * @param	pMBOX	: Pointer to the mailbox register structure
 * @return	See @notes
 * @notes	Returns '1' if the mutex was taken or '0' if another resources has the
