/*
 * @brief LPC540xx State Configurable Timer (SCT/PWM) Chip driver
 *
 * @note
...
#ifndef __SCT_PWM_540XX_H_
#define __SCT_PWM_540XX_H_

#ifdef __cplusplus
extern "C" {
#endif

/** @defgroup SCT_PWM_540XX CHIP: LPC540XX State Configurable Timer PWM driver
