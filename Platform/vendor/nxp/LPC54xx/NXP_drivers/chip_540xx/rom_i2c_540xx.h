/*
 * @brief LPC412X I2C ROM API declarations and functions
 *
 * @note
...
#ifndef __ROM_I2C_412X_H_
#define __ROM_I2C_412X_H_

#ifdef __cplusplus
extern "C" {
#endif

/** @defgroup CHIP_I2CROM_412X CHIP: LPC412X I2C ROM API declarations and functions
 * @ingroup CHIP_412X_Drivers
 * @{
 */

/**
 * @brief LPC412X I2C ROM driver handle structure
 */
typedef void *I2C_HANDLE_T;

/**
 * @brief LPC412X I2C ROM driver callback function
 */
typedef void  (*I2C_CALLBK_T)(uint32_t err_code, uint32_t n);

/**
 * LPC412X I2C ROM driver parameter structure
 */
...
/**
 * LPC412X I2C ROM driver result structure
 */
...
/**
 * LPC412X I2C ROM driver modes enum
 */
...
/**
 * LPC412X I2C ROM driver APIs structure
 */
