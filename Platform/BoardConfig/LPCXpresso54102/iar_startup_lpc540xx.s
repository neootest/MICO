;/*****************************************************************************
; * @file:    startup_LPC540xx.s
; * @purpose: CMSIS Cortex-M4/M0+ Core Device Startup File
; *           for the NXP LPC540xx Device Series (manually edited)
; * @version: V1.00
...
Reserved_IRQHandler
		...
		PUBWEAK FLASH_IRQHandler            ; Non-Volatile Memory Controller
		...
		PUBWEAK CTIMER0_IRQHandler          ; CTIMER0
		PUBWEAK CTIMER1_IRQHandler          ; CTIMER1
		PUBWEAK CTIMER2_IRQHandler          ; CTIMER2
		PUBWEAK CTIMER3_IRQHandler          ; CTIMER3
		PUBWEAK CTIMER4_IRQHandler          ; CTIMER4
		PUBWEAK UART0_IRQHandler            ; UART0             
		PUBWEAK SCT_IRQHandler              ; Smart Counter Timer 
		...
		PUBWEAK ADC0A_IRQHandler            ; ADC0 A sequence (A/D Converter) interrupt
		PUBWEAK ADC0B_IRQHandler            ; ADC0 B sequence (A/D Converter) interrupt
		PUBWEAK ADC_THCMP_OVR_IRQHandler    ; ADC THCMP and OVERRUN ORed
		PUBWEAK RTC_IRQHandler              ; RTC Timer
		PUBWEAK EZH_IRQHandler              ; EZH
		PUBWEAK MBOX_IRQHandler             ; Mailbox 
		...
		PUBWEAK SPI2_IRQHandler             ; SPI2 controller				
		PUBWEAK SPI3_IRQHandler             ; SPI3 controller				
		PUBWEAK OSTIMER_IRQHandler          ; OS Timer
		PUBWEAK PVT0_A_IRQHandler           ; PVT0 Amber                         
		PUBWEAK PVT0_R_IRQHandler           ; PVT0 Red       
		PUBWEAK PVT1_A_IRQHandler           ; PVT1 Amber                         
		PUBWEAK PVT1_R_IRQHandler           ; PVT1 Red  
...
ADC0A_IRQHandler            ; ADC0 A sequence (A/D Converter) interrupt
ADC0B_IRQHandler            ; ADC0 B sequence (A/D Converter) interrupt
